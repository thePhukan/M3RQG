...
from onedecoder_custom_loss_si_NOblipNerPPObuf_valuehead_fixLabel_llava import CustomTrainer
...
max_input_length = 2000 #2824 #265210 #1024 #264192 #2600 #4600    #256
num_epochs = 3
path = "Parent Folder Path"
model = "llava"
config = model+"_oneD_full_r1024bf16_pmtstrct_fixedback_modelargmax"+str(max_input_length)
...
def collate_fn(batch):
    ...
    try:
        ...
        if processor.tokenizer.pad_token_id is not None:
            labels_gem[labels_gem == processor.tokenizer.pad_token_id] = -100
